  ...
  var MugiPack = function MugiPack() {
    ...
    this.encode = function (data) {
      ...
      if (typeof data == "string") {
        t = "s";
        ints = data.split('').map(function (e) {
          return e.charCodeAt(0);
        });
      } else if ((typeof data === "undefined" ? "undefined" : _typeof(data)) == "object") {
        t = "o";
        ints = JSON.stringify(data).split('').map(function (e) {
          return e.charCodeAt(0);
        });
      } else {
      ...
      var dict = this._mkdict(stat.map(function (e) {
        return e[0];
      }), alphabet);
    ...
    this._packDict = function (st) {
      ...
      var res = [];
      st.map(function (e) {
        return e[0].split(',').forEach(function (g) {
          return res.push(_this._nTo62(parseInt(g, 10)));
        });
      });
      return res.join('+');
    };
